...
Includes syntax highlighting, find, undo, keyboard shortcuts, and common code-editing commands. Supported languages include ARM Assembly, CSS, HTML, JavaScript, JSON, Objective-C, Swift, TOML, and XML.
...
See the [DocC documentation](https://lynnswap.github.io/SyntaxEditorUI/) for platform integration, language and theme configuration, editing commands, API references, and migration guides.

## Example and development

Open `SyntaxEditorUI.xcworkspace` and run **Mini** on an iOS Simulator or My Mac to try the supported languages and themes.
