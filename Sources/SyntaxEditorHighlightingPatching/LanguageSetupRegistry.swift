...
package struct HighlightingSetup: Sendable {
    package let rootConfiguration: LanguageConfiguration
    package let injectedLanguageProvider: InjectedLanguageProvider
    package let supportsLayeredHighlighting: Bool
    package let usesHTMLPreprocessing: Bool
}
...
package actor LanguageConfigurationRegistry {
    package static let shared = LanguageConfigurationRegistry()
    ...
    package func highlightingSetup(for language: SyntaxLanguage) async -> HighlightingSetup? {
...
package final class InjectedLanguageProvider: @unchecked Sendable {
...
extension LanguageConfigurationResolver {
    ...
    func makeConfiguration(
        for language: SyntaxLanguage,
        support: SyntaxLanguageTreeSitterSupport
    ...
    func supportedInjectedAliases(
        for support: SyntaxLanguageTreeSitterSupport,
    ...
    func injectionsQuerySource(for support: SyntaxLanguageTreeSitterSupport) -> String? {
        var candidates: [URL] = []
    ...
    static func queryDirectoryCandidates(for support: SyntaxLanguageTreeSitterSupport) -> [URL] {
        let bundleFilename = "\(support.bundleName).bundle"
        var roots: [URL] = []
